...
def quiz():
    ...
    questions = ["I always take the lead in group assignments", "I always finish my assignments on time",
                 "Helping others succeed is more important than my own success", "I work a lot on the side with other things than studies", "I like to tinker with hardware"]
